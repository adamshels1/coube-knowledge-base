...
**Контракты** в системе Coube — это **договоры между компаниями о массовых перевозках** (рамковые соглашения). Это не отдельные договоры на каждую перевозку, а долгосрочные соглашения, которые определяют условия сотрудничества между заказчиком и перевозчиками.
