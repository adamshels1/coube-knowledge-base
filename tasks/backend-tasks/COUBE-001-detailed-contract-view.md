...
Реализовать детальный просмотр контракта с полной информацией согласно дизайну Figma. В дизайне есть экраны детального просмотра контракта, но текущий API возвращает только базовую информацию.
...
- [ ] SCRUM-261: История изменений контракта (для истории)
